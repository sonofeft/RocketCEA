...
# -*- coding: utf-8 -*-
#
# RocketCEA documentation build configuration file, created by
...
target_file = os.path.join( up_one, 'rocketcea','_version.py')
...
htmlhelp_basename = 'RocketCEAdoc'
...
latex_documents = [
  (master_doc, 'RocketCEA.tex', u'RocketCEA Documentation',
...
man_pages = [
    (master_doc, 'projectabcxyz', u'RocketCEA Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'RocketCEA', u'RocketCEA Documentation',
   author, 'RocketCEA', 'One line description of project.',
   'Miscellaneous'),
]
